...
P_blow = 0.5 * (10.0 ** 6.0) #! in equation 3,                              done data in
...
s_r_s = 2.0 #!in equation 8.51                                  data in
R_can = 4.0 #!in equation 8.51                                  data in
R_can_sp = 5.0#!equation 8.51                                   done data in
c_evap_night_3 = 1.1 * (10.0 ** (-11))#! in equation 8.52       done data in
c_evap_day_4 = 5.2 * (10.0 ** (-6))#! in equation 8.52          done data in
...
Vp_can = 2.0 #! in equation 8.47                                data in
Vp_air = 5.0 #! in equation 8.47                                data in (unknown)
...
Vp_top = 400.0#! in equation 8.45                               data in
Vp_out = 300.0#! in equation 8.45                               data in
c_HEC_in = 1.86#! help equation 8.43                            done data in
T_cov_in = 0.5#! help equation 8.43                             data in
A_cov = 9.0 * (10.0 ** 4.0)#! help equation 8.43                done data in
T_Th_Scr = 1.0#! help equation 8.43                             data in
...
plt.title("Plot x_Euler")
plt.xlabel("t")
plt.ylabel("x")

plt.subplot(2,1,2)
plt.plot(list_t, list_y)
plt.title("Plot y_Euler")
plt.xlabel("t")
plt.ylabel("y")
